...
```text
https://<github-user>.github.io/<repo-name>/v120/widgets/pdf-export-widget/manifest.json
https://<github-user>.github.io/<repo-name>/v120/widgets/property-report/manifest.json
https://<github-user>.github.io/<repo-name>/v120/widgets/property-reportv2/manifest.json
```
