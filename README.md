...
```text
https://<github-user>.github.io/<repo-name>/v115/widgets/pdf-export-widget/manifest.json
https://<github-user>.github.io/<repo-name>/v115/widgets/property-report/manifest.json
```
