...
```text
https://<github-user>.github.io/<repo-name>/v130/widgets/pdf-export-widget/manifest.json
https://<github-user>.github.io/<repo-name>/v130/widgets/property-report/manifest.json
https://<github-user>.github.io/<repo-name>/v130/widgets/property-reportv2/manifest.json
```
