...
```text
https://<github-user>.github.io/<repo-name>/v116/widgets/pdf-export-widget/manifest.json
https://<github-user>.github.io/<repo-name>/v116/widgets/property-report/manifest.json
```
